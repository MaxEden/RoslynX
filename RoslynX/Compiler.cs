...
namespace RoslynX
{
    public class Compiler
    {
        ...
        public string BuildProject(string path, string targetFile = null)
        {
        ...
        private void Prepare(CompilerProjectInfo pi)
        {
            ...
            ProjectInfo projectInfo = ProjectInfo.Create(
                ...
                documents: Builder.GetDocuments(result, projectId),
        ...
        public void FileChanged(string path)
        {
            ...
            {
                var projInfo = _projectInfos.FirstOrDefault(p => path.StartsWith(p.Value.Directory)).Value;
